...
[![Build Status](https://dev.azure.com/giovannigualiato/Pipeline-example/_apis/build/status/ggualiato.pipelines-javascript?branchName=master)](https://dev.azure.com/giovannigualiato/Pipeline-example/_build/latest?definitionId=1?branchName=master)
